...
points_second, x_second = g_second.gradient_descent(x, 50, 0.15)
points_second_mom, x_second_mom = g_second_mom.gradient_descent(x, 50, 0.15)
points_bfgs, x_bfgs = g_bfgs.gradient_descent(x, 12, 0.15)
