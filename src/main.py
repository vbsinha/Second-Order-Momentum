...
points_bfgs, x_bfgs = g_bfgs.gradient_descent(x, 10, BacktrackingLineStep(0.5,0.5,10))
points_bfgs_mom, x_bfgs_mom = g_bfgs.gradient_descent(x, 10, BacktrackingLineStep(0.5,0.5,10))
