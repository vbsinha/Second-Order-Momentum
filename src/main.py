...
print x
points_first, x_first = g_first.gradient_descent(x, 500, FixedStep(0.01))
points_first_mom, x_first_mom = g_first_mom.gradient_descent(x, 500, FixedStep(0.01))
points_second, x_second = g_second.gradient_descent(x, 500, FixedStep(0.1))
points_second_mom, x_second_mom = g_second_mom.gradient_descent(x, 500, FixedStep(0.1))
points_bfgs, x_bfgs = g_bfgs.gradient_descent(x, 500, FixedStep(0.1))
points_bfgs_mom, x_bfgs_mom = g_bfgs_mom.gradient_descent(x, 500, FixedStep(0.1)) 
