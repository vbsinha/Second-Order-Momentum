...
points_second_mom, x_second_mom = g_second_mom.gradient_descent(x, 80, FixedStep(0.3))
points_bfgs, x_bfgs = g_bfgs.gradient_descent(x, 40, BacktrackingLineStep(0.3,0.5,10))
